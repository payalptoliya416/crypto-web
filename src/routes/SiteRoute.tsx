...
export default function SiteRoute() {
  return (
    ...
    <main className="bg-white">
      ...
      {/* SECURITY */}
      <motion.div id="security" className="scroll-mt-[88px]" {...sectionAnimation}>
        <FeaturesSection />
        <DefenseSection />
      </motion.div>

       {/* FEATURES */}
      <motion.div id="features" className="scroll-mt-[88px]" {...sectionAnimation}>
        <FeaturesGridSection />
      </motion.div>
      
      {/* VERIFY */}
      <motion.div className="scroll-mt-[88px]" {...sectionAnimation}>
        <SecurityVerifySection />
      </motion.div>

       {/* HOW IT WORKS */}
      <motion.div id="howwork" className="scroll-mt-[88px]" {...sectionAnimation}>
        <GetStarted />
      </motion.div>
      ...
      {/* PLATFORM */}
      <motion.div id="plateform" className="scroll-mt-[88px]" {...sectionAnimation}>
        <AvailabilitySection />
      </motion.div>

        {/* OPEN SOURCE */}
      <motion.div id="openscouce" className="scroll-mt-[88px]" {...sectionAnimation}>
        <BuiltOpenSection />
      </motion.div>
